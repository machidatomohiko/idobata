...
import rehypeSlug from "rehype-slug"; // Automatically generates ID attributes for headings, enabling easy in-page linking
  ...
  return (
    <div className="markdown-body">
      ...
      <ReactMarkdown
        ...
        rehypePlugins={[rehypeRaw, rehypeSanitize, rehypeHighlight, rehypeSlug]} // Enable raw HTML, sanitize, syntax highlighting, and heading IDs
